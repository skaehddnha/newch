package com.dev.ch.common.ibatis;
...
public class SqlMapClientFactoryBean implements FactoryBean<SqlMapClient>, InitializingBean {
	 ...
	 * @see #setLobHandler
	 * @see egovframework.rte.psl.orm.ibatis.support.ClobStringTypeHandler
	 * @see egovframework.rte.psl.orm.ibatis.support.BlobByteArrayTypeHandler
	 * @see egovframework.rte.psl.orm.ibatis.support.BlobSerializableTypeHandler
	 */
